...
import dagshub
dagshub.init(repo_owner='prince210k', repo_name='NETWORKSECURITY', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model_path,train_report,test_report):
        try:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        try:
            ...
            self.track_mlflow("final_model/model.pkl",classification_train_metric,classification_test_metric)
