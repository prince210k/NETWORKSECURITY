...
class ModelTrainerConfig:
    def __init__(self,Training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path: str = os.path.join(self.model_trainer_dir,training_pipeline.TRAINED_MODEL_DIR,training_pipeline.TRAINED_MODEL_NAME)
        self.expected_accuracy: float = training_pipeline.EXPECTED_ACCURACY
        self.overfitting_underfitting_threshold: float = training_pipeline.UNDER_OVER_FITTING_THRESHHOLD
